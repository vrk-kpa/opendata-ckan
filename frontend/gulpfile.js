...
var root_dir = "../modules/opendata-assets/";

var paths = {
  src: {
    images: root_dir + "src/images/**/*",
    less: root_dir + "src/less",
    ckan: root_dir + "src/less/ckan",
    drupal: root_dir + "src/less/drupal/style.less",
    drupal_avoindata_header: "scripts/avoindata_header.js",
    drupal_ckeditor_plugins: root_dir + "src/less/drupal/custom-elements.less",
    templates: root_dir + "src/templates/**/*",
    static_pages: root_dir + "src/static_pages",
    font: root_dir + "src/font/**/*",
    fonts: root_dir + "src/fonts/**/*",
    fontsCss: root_dir + "src/less/fonts.less",
    scripts: root_dir + "src/scripts/**/*",
...
gulp.task("watch", () => {
  var watcher = gulp.watch(
    [root_dir + "src/less/**/*.less", root_dir + "src/less/*.less", paths.src.templates],
    gulp.series("default")
  );
